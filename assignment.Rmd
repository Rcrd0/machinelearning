...
# 3.1 Base model - Classification Trees with Principal Components
...
## 3.2 Classification Trees with all variables
...
## 3.3 Improving using random forests

The random forest approach was by far the one that took more processing time 
...
When submitting the results to Coursera 100% of the values were predicted correctly.
